...
本知识库整合了两大主题:
1. **LLM 提示工程**:来自 Google、Anthropic、OpenAI 等机构的官方文档与最佳实践
2. **AI 智能体 × Obsidian 工作流**:Obsidian CLI、Agent Skills、Token 优化等智能体时代的知识管理范式
...
### 人物
- [[Kepano]] — Obsidian CEO,Minimal 主题作者,Obsidian Skills 推动者
...
- [[Obsidian_CLI]] — Obsidian 官方命令行工具,面向 AI 智能体

### AI 智能体 / 自动化工具
- [[Claude_Code]] — Anthropic 智能体编程工具(CLI)
- [[Gemini_CLI]] — Google 智能体命令行工具(免费额度优先)
- [[n8n]] — 开源可视化工作流自动化平台
...
### AI 智能体生态 / 软件架构
- [[Agent_Skill]] — Agent Skill:智能体扩展能力的标准化包
- [[IPC]] — 进程间通信:Obsidian CLI 的底层机制
- [[Local_First]] — 本地优先:数据主权与隐私设计哲学
- [[Token_Efficiency]] — Token 效率:从提示工程到工具集成的成本控制
